    ...
    async function handleQueueCaptions() {
        ...
        try {
            ...
            if (result.type === 'success') {
                ...
                toast.success(`Successfully queued captions: ${result.data.results.successful}/${result.data.results.total} images`);
            } else {
...
<div class="space-y-4">
    ...
    <div class="flex">
        ...
        <div class="border rounded-lg p-4 bg-white">
            ...
            {#if queueResults}
                <div class="text-sm p-2 rounded bg-gray-50 mb-4">
