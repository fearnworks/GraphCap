...
def caption_images(config: Dict[str, Any]):
	...
	dataloader = DataLoader(dataset, collate_fn=dataset.collate_fn, num_workers=config['num_workers'], shuffle=False, drop_last=False, batch_size=config['batch_size'])
